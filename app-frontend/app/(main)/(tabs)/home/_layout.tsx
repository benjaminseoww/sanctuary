...
export default function HomeLayout() {
  const [activeTab, setActiveTab] = useState<TabOptions>(TabOptions.COLLECTIONS);
  ...
  const handleTabChange = (tab: number) => {
    ...
    switch(tab) {
        case TabOptions.UNSORTED:
            router.push('/(tabs)/home/unsorted');
            break;
        case TabOptions.COLLECTIONS:
            router.push('/(tabs)/home/collections');
            break;
        case TabOptions.TAGS:
            router.push('/(tabs)/home/tags');
            break;
        }
  }
